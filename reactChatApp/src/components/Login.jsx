...
function Login() {
    ...
    function validate(data) {
        ...
        if(!data.password.trim()) {
            ...
            errMsg.password = 'Password must contain atleast 1 uppercase letter, 1 number, and 1 special character';
        }
            ...
            <div className="innerLoginContainer">
                ...
                {showSignUpForm && 
                    <form className="signUpContainer" onSubmit={handleSubmit} id={inputStyle.field}>
                        ...
                        {validationErr.username && <p className='validateErr'>{validationErr.username}</p>}
                        ...
                        {validationErr.email && <p className='validateErr'>{validationErr.email}</p>}
                        ...
                        {validationErr.password && <p className='validateErr'>{validationErr.password}</p>}
                        ...
                        {validationErr.confirmPass && <p className='validateErr'>{validationErr.confirmPass}</p>}
