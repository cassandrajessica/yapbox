                ...
                {showPicUpload && 
                    <>
                        <div className="addProfilePicContainer">
                            <h1>Nice To Meet You, <span className="name">Y/N!</span></h1>
                            <h3>Upload a profile picture</h3>
                            <img src={file ? URL.createObjectURL(file) : profilePic} alt='users profile picture' className='profilePicIcon'/>
